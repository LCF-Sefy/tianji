package com.tianji.stock.sharding;
...
public class DBHashModShardingAlgorithm implements StandardShardingAlgorithm<Long> {
    ...
    private int getShardingCount(final Properties props) {
        ShardingSpherePreconditions.checkState(props.containsKey(SHARDING_COUNT_KEY), () -> new CommonException("Sharding count cannot be null."));
